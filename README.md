...
# Usage:
- git clone `https://github.com/cyberdarker/RED_HAWK`
- cd RED_HAWK
- php rhawk.php
...
Want to contribute to RED HAWK or point out something wrong? Just create a new issue here: https://github.com/cyberdarker/RED_HAWK/issues/new
